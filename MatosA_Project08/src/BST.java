...
public class BST<E> implements Tree<E> {
	 ...
	 * @param list */
	protected java.util.List<E> inorderList(ArrayList<E> list, TreeNode<E> root) {
	 ...
	 * @param list */
	protected java.util.List<E> postorderList(ArrayList<E> list, TreeNode<E> root) {
		if (root == null) return null;
	 ...
	 * @param list */
	protected java.util.List<E> preorderList(ArrayList<E> list, TreeNode<E> root) {
		if (root == null) return null;
		//System.out.print(root.element + " ");
		list.add(root.element);
